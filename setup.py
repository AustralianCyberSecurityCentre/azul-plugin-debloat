...
setup(
    name="azul-plugin-debloat",
    description="Debloat removes excess garbage from bloated executables.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_debloat"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-debloat = azul_plugin_debloat.main:main",
        ]
    },
